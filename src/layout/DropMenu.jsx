...
// export default function DropMenu({ button, position, multiselect, children }) {
...
//       >
//         {(ref) => (
//           <div ref={ref} className={`w-full flex flex-col absolute ${position === 'top' ? 'bottom-full' : 'top-full'} bg-white border border-gray-300 shadow`} onClick={() => setIsOpen(!!multiselect)}>
//             {children}
